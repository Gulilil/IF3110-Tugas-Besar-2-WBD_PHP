...
if (isset($data['id'])){
  ...
  <soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
    ...
    if ($response === FALSE) {
      ...
      $response1 = str_replace('<?xml version=\'1.0\' encoding=\'UTF-8\'?><S:Envelope xmlns:S="http://schemas.xmlsoap.org/soap/envelope/"><S:Body><ns2:insertReferenceResponse xmlns:ns2="http://service.wbd_soap.com/"><return>',"",$response);
      $msg = str_replace('</return></ns2:insertReferenceResponse></S:Body></S:Envelope>',"",$response1);
